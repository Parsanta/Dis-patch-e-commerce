    ...
    return (
        <div>
            <div>
                <div className="py-5">
                    {/* text  */}
                    <h1 className=" text-xl text-indigo-300 font-bold">All Order</h1>
                </div>

                {/* table  */}
                <div className="w-full overflow-x-auto">
                    <table className="w-full text-left border border-collapse sm:border-separate border-indigo-100 text-black-400" >
                        <tbody>
                            <tr>
                                        ...
                                        {order.cartItems.map((item, index) => {
                                            ...
                                            return (
                                                <tr key={index} className="text-black-300">
                                                    ...
                                                    <td onClick={()=>deleteOrder(order.id)} className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-indigo-100 stroke-slate-500 text-slate-500 text-red-500 cursor-pointer ">
                                                        Delete
                                                    </td>
                                                </tr>
                                            )
